...
const DEAFULT_BEHAVIOR = "Mr.InvestorAI  By:";
    ...
    return (
        <div className={styles.container}>
            <div className={styles.inputContainer} >
                ...
                <button className={styles.submit} onClick={updateBehavior}>BANORTE</button>
            </div>
                ...
                <div className={styles.chatContainer}>
                    <MainContainer>
                        <ChatContainer>
                            ...
                            <MessageInput placeholder="Escribe tu duda de Financiamiento"
                                style={{ background: '#BB624'}}
                                onSend={sendMessage}
                                autoFocus={true}
                                attachButton={false}
